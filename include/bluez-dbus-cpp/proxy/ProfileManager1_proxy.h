...
#ifndef __sdbuscpp_____include_bluez_dbus_cpp_proxy_ProfileManager1_proxy_h__proxy__H__
#define __sdbuscpp_____include_bluez_dbus_cpp_proxy_ProfileManager1_proxy_h__proxy__H__
